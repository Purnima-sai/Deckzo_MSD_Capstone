...
const CornellNotes = () => {
  ...
  const saveNote = () => {
    ...
    const updatedProgress = {
      ...progress,
      cornellNotes
        notesCreated: progress.cornellNotes.notesCreated + (currentNote.id ? 0 ),
            ...
            <Card className="card-elevated">
              <CardContent className="p-6">
                ...
                <Input
                  ...
                  onChange={(e) => setCurrentNote({ ...currentNote, title)}
                  className="text-lg"
                />
              </CardContent>
            </Card>
              ...
              <Card className="card-elevated">
                ...
                <CardContent>
                  <Textarea
                    ...
                    onChange={(e) => setCurrentNote({ ...currentNote, cues)}
                ...
                <Card className="card-elevated">
                  ...
                  <CardContent>
                    <Textarea
                      ...
                      onChange={(e) => setCurrentNote({ ...currentNote, notes)}
                      className="min-h-[300px] resize-none"
                    />
                  </CardContent>
                </Card>
            ...
            <Card className="card-elevated">
              ...
              <CardContent>
                <Textarea
                  ...
                  onChange={(e) => setCurrentNote({ ...currentNote, summary)}
