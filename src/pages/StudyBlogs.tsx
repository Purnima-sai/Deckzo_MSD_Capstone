...
const StudyBlogs = () => {
  ...
  const categories = [
    { name: "All Posts", count: 24, icon: <BookOpen className="w-4 h-4" /> },
    { name: "Study Science", count: 8, icon: <Brain className="w-4 h-4" /> },
    { name: "Time Management", count: 6, icon: <Clock className="w-4 h-4" /> },
    { name: "Note Taking", count: 5, icon: <Target className="w-4 h-4" /> },
    { name: "Memory", count: 5, icon: <Brain className="w-4 h-4" /> }
  ];
            ...
            <Card className="card-elevated bg-gradient-to-br from-primary/10 to-focus/10">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Try the "2-minute rule": If a study task takes less than 2 minutes, do it immediately instead of adding it to your to-do list.
                </p>
